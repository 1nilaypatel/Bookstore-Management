  ...
  useEffect(() => {
    const fetchListing = async () => {
      try {
        ...
        const { title, description, price, isbn, author, imageUrls } = response.data;
        setFormData({
          title,
          description,
          price,
  ...
  return (
    <main className="p-3 max-w-5xl mx-auto mt-14 text-slate-800">
      ...
      <div className='flex flex-col flex-1 gap-5'>
        ...
        <button disabled={loading} className="p-3 bg-indigo-300 text-slate-900 rounded-lg uppercase hover:bg-opacity-85 disabled:bg-opacity-40">
